...
const RemControls: React.FC = () => {
  ...
  const updateValues = (oldRemBase: number, newRemBase: number) => {
    ...
    setMinViewportValue(recalculateRem(oldRemBase, newRemBase, isViewportUnitsPx, minViewportValue))
    setMaxViewportValue(recalculateRem(oldRemBase, newRemBase, isViewportUnitsPx, maxViewportValue))
  }
